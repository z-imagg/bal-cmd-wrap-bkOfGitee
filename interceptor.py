...
try:#try业务块
    ...
    if not (fileAtCmd.src_file is  None or fileAtCmd.src_file == '/dev/null' or fileAtCmd.src_file == 'lib/decompress_inflate.c' or fileAtCmd.ism16() ): #当 命令中 有源文件名，才截此命令; 忽略-m16
